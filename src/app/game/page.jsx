...
export default function Game() {
  ...
  return (
    <div className="flex flex-col mt-36 md:mt-64 items-center">
      ...
      <div
        className={`${styles.gameInfo} flex absolute top-[110px] md:top-[180px] w-full justify-around text-white p-4`}
      >
      ...
      <div className={`${styles[level]}`}>
        {cards.length === 0 ? (
          <p className="absolute inset-0 flex justify-center items-center text-blue-800">
            Loading...
          </p>
        ) : (
          cards.map((card) => (
